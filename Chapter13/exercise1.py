...
Add error checking so your program does not traceback if the country code is not there. Once
...
api_key = 'AIzaSyCCtJS9okd4FmW2ODnI0jwxAD6nF_cDuCY'
...
while True:
    ...
    try:
        ...
        print('The location is not in any country')
